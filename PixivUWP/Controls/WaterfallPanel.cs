...
namespace PixivUWP.Controls
{
    public class WaterfallPanel : Panel
    {
        ...
        public int NumberOfColumnsOrRows
        {
            get { return (int)GetValue(NumberOfColumnsOrRowsProperty); }
            set { SetValue(NumberOfColumnsOrRowsProperty, value); }
        }

        public static readonly DependencyProperty NumberOfColumnsOrRowsProperty =
            DependencyProperty.Register("NumberOfColumnsOrRows", typeof(int), typeof(WaterfallPanel), new PropertyMetadata(2));
